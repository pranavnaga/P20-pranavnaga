#ifndef SENDSCRIBBLEAREA_H
#define SENDSCRIBBLEAREA_H
...
//defined a class for scribble area (drawing area) for send window
class SendScribbleArea : public QWidget
{
    Q_OBJECT

public:
    SendScribbleArea(QWidget *parent = 0);

public slots:

    //a clear screen fuction that doesnt work
